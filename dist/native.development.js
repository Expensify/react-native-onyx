...
})(self, (__WEBPACK_EXTERNAL_MODULE_underscore__, __WEBPACK_EXTERNAL_MODULE_expensify_common_lib_str__, __WEBPACK_EXTERNAL_MODULE_lodash_merge__, __WEBPACK_EXTERNAL_MODULE_react_native__, __WEBPACK_EXTERNAL_MODULE_localforage__, __WEBPACK_EXTERNAL_MODULE__react_native_async_storage_async_storage__, __WEBPACK_EXTERNAL_MODULE_react_native_performance__, __WEBPACK_EXTERNAL_MODULE_ascii_table__, __WEBPACK_EXTERNAL_MODULE_react__) => {
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "./node_modules/@babel/runtime/helpers/interopRequireDefault.js");Object.defineProperty(exports, "__esModule", ({ value: true }));exports["default"] = void 0;var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js"));var _classCallCheck2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"));var _createClass2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"));var _get2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/get */ "./node_modules/@babel/runtime/helpers/get.js"));var _inherits2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"));var _possibleConstructorReturn2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"));var _getPrototypeOf2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"));var _asciiTable = _interopRequireDefault(__webpack_require__(/*! ascii-table */ "ascii-table"));function _createSuper(Derived) {var hasNativeReflectConstruct = _isNativeReflectConstruct();return function _createSuperInternal() {var Super = (0, _getPrototypeOf2.default)(Derived),result;if (hasNativeReflectConstruct) {var NewTarget = (0, _getPrototypeOf2.default)(this).constructor;result = Reflect.construct(Super, arguments, NewTarget);} else {result = Super.apply(this, arguments);}return (0, _possibleConstructorReturn2.default)(this, result);};}function _isNativeReflectConstruct() {if (typeof Reflect === "undefined" || !Reflect.construct) return false;if (Reflect.construct.sham) return false;if (typeof Proxy === "function") return true;try {Boolean.prototype.valueOf.call(Reflect.construct(Boolean, [], function () {}));return true;} catch (e) {return false;}}var

MDTable = /*#__PURE__*/function (_AsciTable) {(0, _inherits2.default)(MDTable, _AsciTable);var _super = _createSuper(MDTable);function MDTable() {(0, _classCallCheck2.default)(this, MDTable);return _super.apply(this, arguments);}(0, _createClass2.default)(MDTable, [{ key: "toCSV",
    /**
     * Create a CSV string from the table data
     * @returns {string}
     */value: function toCSV()
    {
      return [this.getTitle(), this.getHeading()].concat((0, _toConsumableArray2.default)(this.getRows())).join('\n');
    }
    ...
    {
      return JSON.stringify((0, _get2.default)((0, _getPrototypeOf2.default)(MDTable.prototype), "toJSON", this).call(this));
    }
    ...
    {var _this = this;
      ...
      var idx = this.getTitle() ? -2 : -1;
      var ascii = (0, _get2.default)((0, _getPrototypeOf2.default)(MDTable.prototype), "toString", this).call(this).
      replace(/-\|/g, function () {
        /* we replace "----|" with "---:|" to align the data to the right in MD */
        idx++;

        if (idx < 0 || _this.leftAlignedCols.includes(idx)) {
          return '-|';
        }
      ...
      var md = ascii.split('\n').slice(1, -1).join('\n');
      return md;
    } }]);return MDTable;}(_asciiTable.default);
 ...
 * @returns {MDTable}
 */
MDTable.factory = function (_ref)

{var title = _ref.title,heading = _ref.heading,_ref$leftAlignedCols = _ref.leftAlignedCols,leftAlignedCols = _ref$leftAlignedCols === void 0 ? [] : _ref$leftAlignedCols,_ref$rows = _ref.rows,rows = _ref$rows === void 0 ? [] : _ref$rows;
  var table = new MDTable({ title: title, heading: heading, rows: rows });
  ...
  heading.forEach(function (name, idx) {return table.setAlign(idx, _asciiTable.default.RIGHT);});
  leftAlignedCols.forEach(function (idx) {return table.setAlign(idx, _asciiTable.default.LEFT);});

  return table;
};var _default =

MDTable;exports["default"] = _default;
...
var _storage = _interopRequireDefault(__webpack_require__(/*! ./storage */ "./lib/storage/index.native.js"));
...
function applyDecorators() {
  ...
  var decorate = __webpack_require__(/*! ./metrics */ "./lib/metrics/index.native.js");
...
var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "./node_modules/@babel/runtime/helpers/interopRequireDefault.js");Object.defineProperty(exports, "__esModule", ({ value: true }));exports.decorateWithMetrics = decorateWithMetrics;exports.getMetrics = getMetrics;exports.resetMetrics = resetMetrics;exports.printMetrics = printMetrics;var _toConsumableArray2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/toConsumableArray */ "./node_modules/@babel/runtime/helpers/toConsumableArray.js"));var _objectWithoutProperties2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/objectWithoutProperties */ "./node_modules/@babel/runtime/helpers/objectWithoutProperties.js"));var _extends2 = _interopRequireDefault(__webpack_require__(/*! @babel/runtime/helpers/extends */ "./node_modules/@babel/runtime/helpers/extends.js"));var _underscore = _interopRequireDefault(__webpack_require__(/*! underscore */ "underscore"));
var _reactNativePerformance = _interopRequireDefault(__webpack_require__(/*! react-native-performance */ "react-native-performance"));
var _MDTable = _interopRequireDefault(__webpack_require__(/*! ../MDTable */ "./lib/MDTable.js"));

var decoratedAliases = new Set();
...
function addMark(alias, args) {
  return _reactNativePerformance.default.mark(alias, { detail: { args: args, alias: alias } });
}
...
function measureMarkToNow(startMark, detail) {
  _reactNativePerformance.default.measure(startMark.name + " [" + startMark.detail.args.toString() + "]", {
    start: startMark.startTime,
    end: _reactNativePerformance.default.now(),
    detail: (0, _extends2.default)({}, startMark.detail, detail) });
 ...
 */
function decorateWithMetrics(func) {var alias = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : func.name;
  ...
  function decorated() {for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {args[_key] = arguments[_key];}
    var mark = addMark(alias, args);

    var originalPromise = func.apply(this, args);
    ...
    * */
    ...
    then(function (result) {
      measureMarkToNow(mark, { result: result });
    }).
    catch(function (error) {
      measureMarkToNow(mark, { error: error });
    });
...
function sum(list, prop) {
  return _underscore.default.reduce(list, function (memo, next) {return memo + next[prop];}, 0);
}
 ...
 */
function getMetrics() {
  var summaries = _underscore.default.chain(_reactNativePerformance.default.getEntriesByType('measure')).
  filter(function (entry) {return entry.detail && decoratedAliases.has(entry.detail.alias);}).
  groupBy(function (entry) {return entry.detail.alias;}).
  map(function (calls, methodName) {
    var total = sum(calls, 'duration');
    var avg = total / calls.length || 0;
    var max = _underscore.default.max(calls, 'duration').duration || 0;
    var min = _underscore.default.min(calls, 'duration').duration || 0;

    // Latest complete call (by end time) for all the calls made to the current method
    var lastCall = _underscore.default.max(calls, function (call) {return call.startTime + call.duration;});
  ...
  var totalTime = sum(_underscore.default.values(summaries), 'total');

  // Latest complete call (by end time) of all methods up to this point
  var lastCompleteCall = _underscore.default.max(
  _underscore.default.values(summaries),
  function (summary) {return summary.lastCall.startTime + summary.lastCall.duration;}).
  lastCall;

  return {
    totalTime: totalTime,
    summaries: summaries,
    lastCompleteCall: lastCompleteCall };
 ...
 */
function toDuration(millis) {var raw = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  if (raw) {
    return millis;
  }
 ...
 */
function printMetrics() {var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},_ref$raw = _ref.raw,raw = _ref$raw === void 0 ? false : _ref$raw,_ref$format = _ref.format,format = _ref$format === void 0 ? 'console' : _ref$format,methods = _ref.methods;var _getMetrics =
  getMetrics(),totalTime = _getMetrics.totalTime,summaries = _getMetrics.summaries,lastCompleteCall = _getMetrics.lastCompleteCall;

  var tableSummary = _MDTable.default.factory({
  ...
  var timeOrigin = _reactNativePerformance.default.timeOrigin;
  var methodNames = _underscore.default.isArray(methods) ? methods : _underscore.default.keys(summaries);

  var methodCallTables = _underscore.default.chain(methodNames).
  filter(function (methodName) {return summaries[methodName] && summaries[methodName].avg > 0;}).
  map(function (methodName) {var _summaries$methodName =
    summaries[methodName],calls = _summaries$methodName.calls,methodStats = (0, _objectWithoutProperties2.default)(_summaries$methodName, ["calls"]);
    tableSummary.addRow(
    methodName,
    ...
    return _MDTable.default.factory({
      title: methodName,
      heading: ['start time', 'end time', 'duration', 'args'],
      leftAlignedCols: [3],
      rows: calls.map(function (call) {return [
        toDuration(call.startTime - _reactNativePerformance.default.timeOrigin, raw),
  ...
  if (/csv|json|string/i.test(format)) {
    var allTables = [tableSummary].concat((0, _toConsumableArray2.default)(methodCallTables));

    return allTables.map(function (table) {
  ...
  var lastComplete = lastCompleteCall && toDuration(
  lastCompleteCall.startTime + lastCompleteCall.duration - timeOrigin, raw);


  var mainOutput = [
  '### Onyx Benchmark', "  - Total: " +
  toDuration(totalTime, raw), "  - Last call finished at: " + (
  lastComplete || 'N/A'),
  '',
  ...
  methodCallTables.forEach(function (table) {
 ...
 */
function resetMetrics() {var _getMetrics2 =
  getMetrics(),summaries = _getMetrics2.summaries;

  _underscore.default.chain(summaries).
  map(function (summary) {return summary.calls;}).
  flatten().
  each(function (measure) {
    _reactNativePerformance.default.clearMarks(measure.detail.alias);
    _reactNativePerformance.default.clearMeasures(measure.name);
  });
}

/***/ }),

/***/ "./lib/storage/NativeStorage.js":
/*!**************************************!*\
  !*** ./lib/storage/NativeStorage.js ***!
  \**************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {

var _interopRequireDefault = __webpack_require__(/*! @babel/runtime/helpers/interopRequireDefault */ "./node_modules/@babel/runtime/helpers/interopRequireDefault.js");Object.defineProperty(exports, "__esModule", ({ value: true }));exports["default"] = void 0;var _AsyncStorage = _interopRequireDefault(__webpack_require__(/*! ./providers/AsyncStorage */ "./lib/storage/providers/AsyncStorage.js"));var _default =

_AsyncStorage.default;exports["default"] = _default;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));exports["default"] = void 0;var _reactNative = __webpack_require__(/*! react-native */ "react-native");

var Storage = _reactNative.Platform.select({
  default: function _default() {return (__webpack_require__(/*! ./WebStorage */ "./lib/storage/WebStorage.js")["default"]);},
  native: function native() {return (__webpack_require__(/*! ./NativeStorage */ "./lib/storage/NativeStorage.js")["default"]);} })();var _default2 =


Storage;exports["default"] = _default2;

/***/ }),

/***/ "./lib/storage/providers/AsyncStorage.js":
/*!***********************************************!*\
  !*** ./lib/storage/providers/AsyncStorage.js ***!
  \***********************************************/
/***/ ((__unused_webpack_module, exports, __webpack_require__) => {
...
var _asyncStorage = _interopRequireDefault(__webpack_require__(/*! @react-native-async-storage/async-storage */ "@react-native-async-storage/async-storage")); /**
 ...
 */var provider = { /**
  ...
  multiGet: function multiGet(keys) {
    ...
    then(function (pairs) {return _underscore.default.map(pairs, function (_ref) {var _ref2 = (0, _slicedToArray2.default)(_ref, 2),key = _ref2[0],value = _ref2[1];return [key, value && JSON.parse(value)];});});
  },
   ...
   * @return {Promise<void>}
   */
  multiSet: function multiSet(pairs) {
    var stringPairs = _underscore.default.map(pairs, function (_ref3) {var _ref4 = (0, _slicedToArray2.default)(_ref3, 2),key = _ref4[0],value = _ref4[1];return [key, JSON.stringify(value)];});
    return _asyncStorage.default.multiSet(stringPairs);
  },
   ...
   * @return {Promise<void>}
   */
  multiMerge: function multiMerge(pairs) {
    var stringPairs = _underscore.default.map(pairs, function (_ref5) {var _ref6 = (0, _slicedToArray2.default)(_ref5, 2),key = _ref6[0],value = _ref6[1];return [key, JSON.stringify(value)];});
    return _asyncStorage.default.multiMerge(stringPairs);
  },
   ...
   * @returns {Promise<String[]>}
   */
  getAllKeys: _asyncStorage.default.getAllKeys,
   ...
   * @returns {Promise<void>}
   */
  removeItem: _asyncStorage.default.removeItem,

  /**
   * Clear absolutely everything from storage
   * @returns {Promise<void>}
   */
  clear: _asyncStorage.default.clear };var _default =
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE__react_native_async_storage_async_storage__;
...
"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_ascii_table__;
...
/*!*******************************************!*\
  !*** external "react-native-performance" ***!
  \*******************************************/
/***/ ((module) => {

"use strict";
module.exports = __WEBPACK_EXTERNAL_MODULE_react_native_performance__;
...
//# sourceMappingURL=native.development.js.map