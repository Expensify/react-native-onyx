...
/**
 * Alternative function for underscore max
 * @param {Array} arr
 * @param {Function} func
 * @returns {Object}
 */
...
/**
 * Alternative function for underscore min
 * @param {Array} arr
 * @param {Function} func
 * @returns {Object}
 */
...
export default {areObjectsEmpty, fastMerge, minBy, maxBy, formatActionName, removeNestedNullValues};
