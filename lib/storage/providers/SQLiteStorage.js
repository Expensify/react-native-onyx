...
/**
 * In very extreme circumstances we might want to disable writing complete e.g. when the user is exceeding their device storage to the point that we
 * can't possibly store additional critical data.
 */
