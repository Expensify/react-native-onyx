    ...
    return (WrappedComponent) => {
        ...
        class withOnyx extends React.Component {
            ...
            componentDidUpdate(prevProps, prevState) {
                ...
                const mappingPropNames = _.pluck(mapOnyxToState, 'key');
                const prevStateOnlyWithOnyxData = _.pick(prevState, mappingPropNames);
                ...
                _.each(mapOnyxToState, (mapping, propName) => {
                    const previousKey = Str.result(mapping.key, {...prevProps, prevStateOnlyWithOnyxData});
