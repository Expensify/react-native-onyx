    ...
    return (WrappedComponent) => {
        ...
        class withOnyx extends React.Component {
            ...
            constructor(props) {
                ...
                this.getWithOnyxState = this.getWithOnyxState.bind(this);
            ...
            componentDidUpdate(prevProps, prevState) {
                ...
                if (displayName === 'LHNOptionsList') {
                    console.group('[withOnyx] Component LHN update');
                    console.log('[withOnyx] onyxDataFromState', onyxDataFromState.reports);
                    console.log('[withOnyx] prevOnyxDataFromState', prevOnyxDataFromState.reports);
                    console.groupEnd();
                }

                console.group(`[withOnyx] Component update ${displayName}`);
                console.log('[withOnyx] onyxDataFromState', onyxDataFromState);
                console.log('[withOnyx] prevOnyxDataFromState', prevOnyxDataFromState);
                console.groupEnd();
            ...
            getWithOnyxState(mapping) {
                const {key, statePropertyName} = mapping;
                const dataToUpdate = OnyxUtils.tryGetCachedValue(key, mapping);

                console.group('[withOnyx] setWithOnyxState');
                console.log('[withOnyx] statePropertyName', statePropertyName);
                console.log('[withOnyx] setWithOnyxState', mapping);
                console.log('[withOnyx] dataToUpdate', dataToUpdate);
                console.groupEnd();

                this.setState(() => ({
                    loading: false,
                    [statePropertyName]: dataToUpdate,
                }));
            }
