        ...
        class withOnyx extends React.Component {
            ...
            componentDidUpdate(prevProps, prevState) {
                ...
                _.each(mapOnyxToState, (mapping, propName) => {
                    ...
                    const previousKey = OnyxUtils.getCacheKey(isFirstTimeUpdatingAfterLoading ? mapping.previousKey : Str.result(mapping.key, {...prevProps, ...prevOnyxDataFromState}));
                    const newKey = OnyxUtils.getCacheKey(Str.result(mapping.key, {...this.props, ...onyxDataFromState}));
