 ...
 */
// eslint-disable-next-line rulesdir/no-negated-variables
function notifySubscribersAndWriteToStorage(key, value, method = Storage.setItem) {
...
function set(key, value) {
    return notifySubscribersAndWriteToStorage(key, value);
}
...
function merge(key, value) {
    ...
    // @TODO - we still need to cache these values...
