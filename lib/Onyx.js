...
function applyDecorators() {
    ...
    multiSet = decorate.decorateWithMetrics(get, 'Onyx:multiSet');
    clear = decorate.decorateWithMetrics(get, 'Onyx:clear');
    merge = decorate.decorateWithMetrics(get, 'Onyx:merge');
    mergeCollection = decorate.decorateWithMetrics(get, 'Onyx:mergeCollection');
    AsyncStorage.getAllKeys = decorate.decorateWithMetrics(AsyncStorage.getAllKeys, 'AsyncStorage:getAllKeys');
    /* eslint-enable */
