 ...
 * @returns {Boolean} Whether there was a problem initializing the platform storage provider and Onyx uses the fallback provider instead.
 * @example
 * Onyx.init({
 *     keys: ONYXKEYS,
 *     initialKeyStates: {
...
function init({
    ...
    const isUsingFallback = Storage.init();
