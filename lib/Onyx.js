...
function update(data) {
    ...
    return clearPromise.then(() => Storage.multiGet(_.keys(updateQueue)).then((pairs) => {
        ...
        const updatedSnapshot = _.reduce(updateQueue, (acc, operations, key) => {
            ...
            const updatedValue = _.isEmpty(mergeOperations) ? existingValue : applyMerge(existingValue, _.map(mergeOperations, ({value}) => value), true);
