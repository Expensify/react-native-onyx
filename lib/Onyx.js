 ...
 */
function prepareKeyValuePairsForStorage(data, shouldRemoveNullObjectValues = true) {
...
function mergeCollection(collectionKey, collection) {
    ...
    return getAllKeys().then((persistedKeys) => {
        ...
        const keyValuePairsForExistingCollection = prepareKeyValuePairsForStorage(existingKeyCollection, false);
