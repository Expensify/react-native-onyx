 ...
 *      If it's a function, it is passed the sourceObject and it should return the simplified object
 * @returns {Object}
 */
 ...
 * The resulting collection will only contain items that included values returned by the selector.
...
const reduceCollectionWithSelector = (collection, selector) => _.reduce(collection, (finalCollection, item, key) => {
    ...
    // There is enough overhead when using a spread operator that it is best to use Object.assign() directly
    // since this is the very core foundation and needs to be performant.
