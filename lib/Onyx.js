...
function set(key, value) {
    ...
    // In case value is an object we want to remove all null values
    // utils.fastMerge recursively goes through the object and removes all null values
    // Passing two same object as source and target to fastMerge will not change it, but only remove the null values
 ...
 * @returns {*}
 */
function applyMerge(existingValue, changes, shouldRemoveNullObjectValues = true) {
