 ...
 * @returns {Promise}
 */
function set(key, value, resolveOnBroadcast) {
    if (_.isNull(value)) {
        return remove(key);
    }
 ...
 * @returns {Promise}
 */
function multiSet(data, resolveOnBroadcast) {
 ...
 * @returns {Promise}
 */
function merge(key, changes, resolveOnBroadcast) {
 ...
 * @returns {Promise}
 */
function mergeCollection(collectionKey, collection, resolveOnBroadcast) {
