 ...
 *
 * @private
 * @param {Array<any>} changes Array of changes that should be applied to the existing value
 * @param {*} existingValue
 * @returns {*}
 */
function applyMerge(changes, existingValue = {}) {
    ...
    if (_.isUndefined(existingValue) || _.isNull(existingValue) || _.isUndefined(lastChange) || _.isNull(lastChange)) {
        return lastChange;
    }
