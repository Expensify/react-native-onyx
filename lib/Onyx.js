...
function init({
    ...
    if (shouldSyncMultipleInstances && _.isFunction(Storage.keepInstancesSync)) {
        Storage.keepInstancesSync(keyChanged);
    }
}
...
function prepareFile(file) {
    // Some storage providers need to prepare the files others can directly save the file
    if (_.isFunction(Storage.prepareFile)) {
