...
function merge(key, value) {
    ...
    return new Promise((resolve) => {
        get(key).then(currentValue => Storage.mergeItem(key, value, currentValue).then(updatedValue => resolve(notifyAndWriteToStorage(key, updatedValue, Storage.mergeItem))));
    });
}
