...
// pending set or merge operations by key
const keyOperations = {};
...
function set(key, value) {
    ...
    // wait any prior updates by chaining after an existing promise or set up a new chain
    const writePromise = keyOperations[key] || Promise.resolve();

    keyOperations[key] = writePromise
