...
function set(key, value) {
    ...
    return notify(key, value, "set").then(() => setPromise).catch(error => evictStorageAndRetry(error, set, key, value));
}
    ...
    return get(key)
        .then((data) => {
            try {
                ...
                return notify(key, modifiedData, "merge").then(() => mergePromise);
            } catch (error) {
