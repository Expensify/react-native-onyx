...
describe('Onyx.mergeCollection() and WebStorage', () => {
    ...
    it('merges two sets of data consecutively', () => {
        ...
        expect(StorageMock.getStore().test_1).toEqual(initialTestObject);
        expect(StorageMock.getStore().test_2).toEqual(initialTestObject);
        expect(StorageMock.getStore().test_3).toEqual(initialTestObject);
    ...
    it('cache updates correctly when accessed again if keys are removed or evicted', () => {
        // Given empty storage
        expect(StorageMock.getStore().test_1).toBeFalsy();
        expect(StorageMock.getStore().test_2).toBeFalsy();
        expect(StorageMock.getStore().test_3).toBeFalsy();
        ...
        return waitForPromisesToResolve()
            .then(() => {
                ...
                expect(StorageMock.getStore().test_1).toEqual(data);
                expect(StorageMock.getStore().test_2).toEqual(data);
                expect(StorageMock.getStore().test_3).toEqual(data);
    ...
    it('setItem() and multiMerge()', () => {
        ...
        expect(StorageMock.getStore()).toEqual({});
